      ...
      <div className="bg-hero-gradient">
        ...
        <div className="mt-10 grid items-start gap-8 lg:grid-cols-2">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-3 rounded-lg border border-border bg-card p-4 text-xs text-muted-foreground">
...
function TrustChip({
  ...
  return (
    <div className="flex items-center gap-2 rounded-lg border border-border/70 bg-card px-4 py-3 text-sm text-foreground/80">
