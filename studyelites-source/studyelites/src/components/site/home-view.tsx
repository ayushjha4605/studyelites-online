  ...
  return (
    <div>
      ...
      <section className="bg-hero-gradient">
        <div className="mx-auto grid max-w-6xl items-center gap-10 px-4 py-16 sm:px-6 md:grid-cols-2 md:py-24">
          ...
          <div className="relative hidden md:block">
            <div className="relative mx-auto w-full max-w-sm rounded-2xl border border-blue-100 bg-white p-6 shadow-sm">
      ...
      <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
        ...
        <div className="mt-10 flex flex-col items-center gap-3 rounded-2xl border border-blue-200 bg-blue-50/40 p-6 sm:p-8">
