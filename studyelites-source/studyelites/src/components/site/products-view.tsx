  ...
  return (
    <div>
      ...
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6">
        ...
        <div className="mt-6 flex items-start gap-3 rounded-lg border border-blue-100 bg-blue-50/60 p-4 text-sm text-blue-900/80">
        ...
        {/* Membership teaser */}
        <div className="mt-12 flex flex-col items-start justify-between gap-6 rounded-2xl border border-blue-200 bg-blue-50/50 p-6 sm:p-8 md:flex-row md:items-center">
