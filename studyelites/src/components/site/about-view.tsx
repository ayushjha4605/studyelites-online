...
export function AboutView({
  ...
  return (
    <div>
      ...
      <div className="mt-10 rounded-2xl border border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-900/20 p-6">
        <div className="flex items-start gap-4">
          <div className="flex size-10 shrink-0 items-center justify-center rounded-xl bg-card text-blue-700 dark:text-blue-300 ring-1 ring-blue-200 dark:ring-blue-800">
      ...
      <div className="mt-10 flex flex-wrap gap-3">
        ...
        <button
          ...
          className="rounded-md border border-blue-300 dark:border-blue-700 px-4 py-2 text-sm font-medium text-blue-700 dark:text-blue-300 hover:bg-blue-50 dark:hover:bg-blue-900/30"
        >
          View membership
        </button>
        <button
